...
, spectrometer : SPECTROMETER , ddc_coeff_addr : DDC_COEFF_ADDR , ddc_coeff : DDC_COEFF , ddc_decimation : DDC_DECIMATION , ddc_control : DDC_CONTROL , } impl RegisterBlock { # [doc = "0x00 - product_id"]
# [inline (always)]
...
# [inline (always)]
pub const fn ddc_decimation (& self) -> & DDC_DECIMATION { & self . ddc_decimation } # [doc = "0x30 - ddc_control"]
# [inline (always)]
...
# [inline (always)]
pub fn num_integrations (& self) -> NUM_INTEGRATIONS_R { NUM_INTEGRATIONS_R :: new (((self . bits >> 1) & 0x03ff) as u16) } # [doc = "Bits 11:13 - last_buffer"]
# [inline (always)]
pub fn last_buffer (& self) -> LAST_BUFFER_R { LAST_BUFFER_R :: new (((self . bits >> 11) & 7) as u8) } # [doc = "Bit 14 - peak_detect"]
# [inline (always)]
pub fn peak_detect (& self) -> PEAK_DETECT_R { PEAK_DETECT_R :: new (((self . bits >> 14) & 1) != 0) } } impl W { # [doc = "Bit 0 - use_ddc_out"]
# [inline (always)]
# [must_use]
pub fn use_ddc_out (& mut self) -> USE_DDC_OUT_W < SPECTROMETER_SPEC > { USE_DDC_OUT_W :: new (self , 0) } # [doc = "Bits 1:10 - num_integrations"]
# [inline (always)]
# [must_use]
pub fn num_integrations (& mut self) -> NUM_INTEGRATIONS_W < SPECTROMETER_SPEC > { NUM_INTEGRATIONS_W :: new (self , 1) } # [doc = "Bit 14 - peak_detect"]
# [inline (always)]
# [must_use]
pub fn peak_detect (& mut self) -> PEAK_DETECT_W < SPECTROMETER_SPEC > { PEAK_DETECT_W :: new (self , 14) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
