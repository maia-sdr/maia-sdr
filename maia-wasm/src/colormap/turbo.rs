//! Turbo colormap.
//!
//! Turbo is an an improved rainbow colormap for visualization by Anton
//! Mikhailov, Senior Software Engineer, Daydream, Google. It is released as a
//! 256-entry RGB LUT (contained here), or as a polynomial approximation (of
//! which a GLSL implementation can be found in `turbo_colormap.glsl`. See the
//! [Turbo colormap
//! documentation](https://ai.googleblog.com/2019/08/turbo-improved-rainbow-colormap-for.html).
...
/// The Turbo colormap, as a 256-entry RGB LUT.
///
/// R, G, B components are interleaved in the same array, so that the array can
/// be used as an OpenGL texture.
pub static COLORMAP: [u8; 256 * 3] = [
