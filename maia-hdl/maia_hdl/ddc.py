...
class DDC(Elaboratable):
    ...
    This module implements a DDC that uses FIRDecimator3Stage. The FIR
    decimator runs with a 3x clock, but the input and output use a 1x clock.
    ...
    """
    def __init__(self, domain_3x, *, in_width=12, out_width=[16]*3,
    ...
    def elaborate(self, platform):
        ...
        m.d.comb += [
            inbuff.in_data.eq(Cat(self.re_in, self.im_in)),
            inbuff.in_valid.eq(
